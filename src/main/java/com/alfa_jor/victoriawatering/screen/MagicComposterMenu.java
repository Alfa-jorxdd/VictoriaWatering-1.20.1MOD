package com.alfa_jor.victoriawatering.screen;
...
public class MagicComposterMenu extends AbstractContainerMenu {

    public final MagicComposterBlockEntity blockEntity;
    public final Level level;
    public final ContainerData data;

    public MagicComposterMenu(int pContainerID, Inventory iv, FriendlyByteBuf extraData){
        this(pContainerID, iv, iv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos())
                , pPlayer, ModBlocks.MAGIC_COMPOSTER.get());
    }
